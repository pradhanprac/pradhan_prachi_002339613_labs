 ...
 * @author prach
 */
public class MainJJrame extends javax.swing.JFrame {
    
    private AccountDirectory accountDirectory;

    /**
     * Creates new form MainJJrame
     */
    public MainJJrame() {
        initComponents();
    ...
    private void initComponents() {
        ...
        btnAccountMng.setBackground(new java.awt.Color(204, 255, 204));
        ...
        topJPanelLayout.setHorizontalGroup(
            ...
            .addGroup(topJPanelLayout.createSequentialGroup()
                .addGap(38, 38, 38)
                .addComponent(btnAccountMng, javax.swing.GroupLayout.PREFERRED_SIZE, 351, javax.swing.GroupLayout.PREFERRED_SIZE)
        ...
        topJPanelLayout.setVerticalGroup(
            ...
            .addGroup(topJPanelLayout.createSequentialGroup()
                .addGap(26, 26, 26)
                .addComponent(btnAccountMng, javax.swing.GroupLayout.PREFERRED_SIZE, 42, javax.swing.GroupLayout.PREFERRED_SIZE)
    ...
    private void btnAccountMngActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAccountMngActionPerformed
        ...
        userProcessContainer.add("AccountManPanel Working",panel);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(MainJJrame.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new MainJJrame().setVisible(true);
            }
        });
    }
...
private void generateDemoData(){
    ...
    newAccount.setRoutingNumber("55555555");
    newAccount.setBankName("BANK OF AMERICA");
    newAccount.setBalance(52222);
    Account anotherNewAccount=accountDirectory.addAccount();
    anotherNewAccount.setAccountNumber("455454");
    anotherNewAccount.setRoutingNumber("545656");
    anotherNewAccount.setBankName("CHASE");
    anotherNewAccount.setBalance(855569);
